...
const PopularProduct = () => {
  ...
  return (
    <div className="container mx-auto my-8 border border-black p4">
      <h1 className="font-bold text-2xl">Top Popular Product</h1>
      <div className="container mx-auto">
        <div className="w-full flex gap-2 justify-end">
          <span
            onClick={() => setCategory("mobiles")}
            className="font-semibold border border-blue-600 px-2 text-blue-500 cursor-pointer hover:bg-blue-300 hover:text-black"
          >
            Mobile
          </span>
          <span
